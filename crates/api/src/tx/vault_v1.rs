...
pub struct VaultV1TransactionClient<P> {
    provider: P,
    signer_address: Address,
}

impl VaultV1TransactionClient<HttpProvider> {
...
impl<P: Provider + Clone> VaultV1TransactionClient<P> {
    /// Create a new V1 transaction client with a custom provider.
